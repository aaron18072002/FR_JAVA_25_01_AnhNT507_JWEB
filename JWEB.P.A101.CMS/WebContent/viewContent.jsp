		...
		<nav class="sidebar d-none d-md-block">
			...
			<div style="padding: 15px">
				...
				<ul class="nav flex-column">
					<li class="nav-item">
						<a class="nav-link" href="<%=request.getContextPath()%>/ContentViewServlet"><i
						class="fas fa-th-list"></i> View contents</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="<%=request.getContextPath()%>/addContent.jsp"><i
